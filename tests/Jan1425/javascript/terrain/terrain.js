...
function createTreeVariantAncientOak(scale) {
    const canopyOffset = -6; // Further lowering the canopy
    ...
    for (let i = 0; i < foliageLayers; i++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
...
function createTreeVariantToweringPine(scale) {
    ...
    foliage.castShadow = true;
    foliage.receiveShadow = true;
    foliage.position.y = trunkHeight * scale - sphereRadius * 0.7; // Lowered position to envelop trunk
    trunk.add(foliage);
...
function createTreeVariantMightyRedwood(scale) {
    ...
    for (let c = 0; c < clusters; c++) {
        ...
        foliage.position.y = trunkHeight * scale - sphereRadius * 0.7 + (Math.random() * 2 * scale) - sphereRadius * 0.3; // Lowered position
...
function createTreeVariantElderBirch(scale) {
    ...
    for (let f = 0; f < frondCount; f++) {
        ...
        frond.position.y = trunkHeight * scale + canopyOffset; // Further lowered
...
function createTreeVariantSacredAsh(scale) {
    ...
    for (let i = 0; i < layers; i++) {
        ...
        // Positioning: Ensure canopy starts below the trunk's top
        canopy.position.y = trunkHeight * scale + i * (3 * scale) - canopyHeight * 0.8; // Further lowered position
...
function createTreeVariantMysticMaple(scale) {
    ...
    for (let i = 0; i < clusterCount; i++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
        coneFoliage.position.y = trunkHeight * scale - subHeight * 0.6 + i * (3 * scale) - subHeight * 0.2; // Further lowered position
...
function createTreeVariantWhisperingWillow(scale) {
    ...
    for (let f = 0; f < foliageCount; f++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
        foliage.position.y = trunkHeight * scale - foliageHeight * 0.5 - 3; // Further lowered position
        trunk.add(foliage);
    }
...
function createTreeVariantEnchantedSpruce(scale) {
    ...
    for (let i = 0; i < foliageLayers; i++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
        foliage.position.y = trunkHeight * scale - coneHeight * 0.3 + i * (3 * scale) - 3; // Further lowered position
        foliage.rotation.y = Math.random() * Math.PI * 2;
        trunk.add(foliage);
    }
...
function createTreeVariantTwilightCypress(scale) {
    ...
    for (let i = 0; i < foliageLayers; i++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
        foliage.position.y = trunkHeight * scale - coneHeight * 0.4 + i * (2.5 * scale) - 3; // Further lowered position
        foliage.rotation.y = Math.random() * Math.PI * 2;
        trunk.add(foliage);
    }
...
function createTreeVariantSilverBirch(scale) {
    ...
    for (let i = 0; i < foliageLayers; i++) {
        ...
        // Positioning: Ensure foliage starts below the trunk's top
        foliage.position.y = trunkHeight * scale - coneHeight * 0.2 + i * (3 * scale) - 3; // Further lowered position
        foliage.rotation.y = Math.random() * Math.PI * 2;
        trunk.add(foliage);
    }
